...
import Coaching from "@/components/coachinig";
...
export default function Nosservices() {
    ...
    //                     <div className="w-full tablet:w-[50%] pt-14">
    ...
    //         {/* section  */}
    //         <div className="w-full max-w-7xl m-auto h-fit pb-6 mb-12">
    //             <div className="w-fit h-fit m-auto mb-12">
