...
export default function Coaching() {
    ...
    return (
        <div className="w-full px-3 tablet:px-0 ">
                ...
                <div className="w-full h-fit flex flex-col items-center justify-center">
                    ...
                    <div className="flex flex-col tablet:flex-row">
                        <div className="w-full tablet:w-[50%] pt-14 mb-[60px]">
                            <h1 className="font-bold my-6 text-[30px]">Et si vendre devenait un Jeu d&apos;enfant !</h1>
                            <p>
                                {bannertext}
                            </p>
                            <Link href='#contact'>
            ...
            {/* section  */}
            <div className="w-full max-w-7xl m-auto h-fit pb-6 mb-12 mt-[60px] mintablet:mt-[40px]">
                <div className="w-fit h-fit m-auto mintablet:mb-12">
                    <h1 className="font-bold text-[32px]">A Propos</h1>
                </div>
                <div className="flex flex-col-reverse tablet:flex-row justify-between">
                    {/* image */}
                    <div className="w-full h-full target:w-[50%] pt-6 mt-3 tablet:mt-0 ">
